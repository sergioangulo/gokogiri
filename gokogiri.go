...
import (
	"github.com/sergioangulo/gokogiri/html"
	"github.com/sergioangulo/gokogiri/xml"
)
...
found in the github.com/sergioangulo/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
